...
//zmieniamy test shouldCalculateStringLengthWithoutSpaces, dodajemy:
private static Stream<Arguments> provideStringsForTestingLength() {
    ...
    //Delimiter musi być typu char: jest to pojedynczy znak, który będzie używany
    // do separowania wartości wejściowej od wartości oczekiwanej
